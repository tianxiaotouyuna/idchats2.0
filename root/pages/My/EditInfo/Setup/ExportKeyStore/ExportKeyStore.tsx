...
const ExportKeyStore: FunctionComponent = (props) => {
    ...
    return (
        ...
        <IDBitTabBg style={{ paddingHorizontal: pxToDp(34), paddingVertical: pxToDp(26) ,width:'100%'}}>
            <View style={{ flexDirection: 'row', alignItems: 'flex-start',width:'100%' }}>
                ...
                <Text style={{ textAlignVertical: 'top', marginLeft: pxToDp(6), color: '#FC5143', fontSize: pxToSp(28), lineHeight: pxToDp(40) }}>{t('my.exportKeystoreTips')}</Text>
            </View>
        </IDBitTabBg>
            ...
            <IDBitTabBg style={{marginTop:pxToDp(60), paddingHorizontal: pxToDp(34), paddingVertical: pxToDp(26),marginBottom: pxToDp(88) }}>
                <Text style={{ fontSize: pxToSp(30), color: '#ABABAB' }}>{thisWallet?.keyStore}</Text>
            </IDBitTabBg>
        </View>
            <IDBitBtn text={t('my.copyKeystore')} containerStyle={{ height: pxToDp(88), alignSelf: "center", paddingHorizontal: pxToDp(60) - UIELEMENTS.PADDING_HORIZONTAL }} onPress={copyAdress}></IDBitBtn>
    </View>
    );
};
