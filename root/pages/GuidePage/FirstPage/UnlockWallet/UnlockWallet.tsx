...
const UnlockWallet: FunctionComponent = (props) => {
  ...
  const checkPwd = () => {
    ...
    if (password == undefined) {
      ...
      setTimeout(async () => {
        setisShow(false)
        await Storage.save('walletPwd', password)
  ...
  return (
    <View style={styles.container}>
      <View style={styles.bottomWrap}>
        <Text style={styles.text1}>IDChats！首先，</Text>
        <Text style={styles.text1}>我们来保护你的钱</Text>
        <Text style={styles.text2}>您暂时无法更改此密码</Text>
        ...
        <View style={{ backgroundColor: UIELEMENTS.DEFAULT_ITEM_BACKGROUND_COLOR, flexDirection: 'row', width: '100%', height: pxToDp(104), marginTop: pxToDp(24), borderRadius: pxToDp(16), paddingRight: pxToDp(40), marginTop: pxToDp(24), borderColor: 'rgba(56, 56, 56, 0.3)', borderWidth: pxToDp(2) }}>
          <TextInput placeholderTextColor={'#5C616C'} placeholder={t('guidePage.pleasePwd')} onChangeText={text => setpassword(text)} style={{ color: 'white', width: '100%', height: '100%', marginLeft: pxToDp(32) }}
            value={password}></TextInput>
        </View>
        <Text style={styles.textPwd}>确认密码</Text>
        <View style={{ backgroundColor: UIELEMENTS.DEFAULT_ITEM_BACKGROUND_COLOR, flexDirection: 'row', width: '100%', marginTop: pxToDp(24), height: pxToDp(104), borderRadius: pxToDp(16), paddingRight: pxToDp(40), marginTop: pxToDp(24), borderColor: 'rgba(56, 56, 56, 0.3)', borderWidth: pxToDp(2) }}>
          <TextInput placeholderTextColor={'#5C616C'} placeholder={t('guidePage.pleasePwd2')} onChangeText={text => setpassword2(text)} style={{ color: 'white', width: '100%', height: '100%', marginLeft: pxToDp(32) }}
      ...
      <Loading isShow={isShow} onTimeOut={() => setisShow(false)} text={t('common.loading')}></Loading>
    </View>
  );
};
