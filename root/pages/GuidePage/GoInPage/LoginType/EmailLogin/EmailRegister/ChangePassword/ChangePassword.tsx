  ...
  return (
    <View style={[styles.container, { paddingTop: useHeaderHeight() + UIELEMENTS.PADDING_TOP }]}>
      ...
      <View style={{ marginBottom: pxToDp(136), width: '100%' }}>
        <IDBitTabBg style={{ width: '100%', height: pxToDp(112), alignItems: 'center', flexDirection: 'row', justifyContent: 'space-around', borderRadius: pxToDp(32), marginTop: pxToDp(24) }}>
          <TextInput style={{ height: pxToDp(88), width: '80%', color: '#fff', borderRadius: pxToDp(32) }} placeholder="新密码" placeholderTextColor={'#7082A0'}></TextInput>
      ...
      <IDBitBtn text={'确定'} containerStyle={{ borderRadius: pxToDp(32), height: pxToDp(104), marginBottom: pxToDp(136) }} onPress={()=>Navigate.navigate('SetPayPassword')}></IDBitBtn>
