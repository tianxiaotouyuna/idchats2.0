...
//   const [titleIn, settitleIn] = useState(t('guidePage.recovery'));
...
//     return  isAndroid==true?<TouchableHighlight underlayColor="lightgray"  onPressOut={()=>selectItemIn([t('guidePage.recovery'), t('guidePage.private'),t('guidePage.keystore')][index],index)}>
...
//       <Text  style={{color: '#0D0E10',fontSize:pxToSp(32)}}>{[t('guidePage.recovery'), t('guidePage.private'),t('guidePage.keystore')][index]}</Text>
//          {
//           index==selectIndex?
...
//        onSelect={(index: any, value: any) => selectItemIn(value, index)} options={[t('guidePage.recovery'), t('guidePage.private'),t('guidePage.keystore')]} 
//        animated={true}
...
const DropDownTab: FunctionComponent<butonProps> = (props) => {
  ...
  return (
      <ModalDropdown style={{width:'100%'}}
       ...
       onDropdownWillHide={()=>setrigthImg(require('@/resources/idbt/icon_shangla.png'))}
      //  dropdownTextStyle={{backgroundColor:}}
       dropdownStyle={{marginTop:pxToDp(4),borderRadius:pxToDp(16),overflow:'hidden',height:pxToDp((106+2)*2),width:windowWidth-2*pxToDp(32)}}
       renderSeparator={()=><View style={{marginHorizontal:pxToDp(32), height: pxToDp(1) ,backgroundColor:'#D4D4D4'}}></View>}
       renderRow={renderItem}
       ref={dropRef}
       >
