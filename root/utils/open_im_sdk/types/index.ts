...
export type GetFollowListParams = {
  toUserID: string;//查询人的ID
  selectFans: boolean;//false关注我的
};
...
export type FollowAddFriendParams = {
  toUserID: string;
  follow: boolean | undefined;
};

export type updateProduceParams = {
  userProfile: string;
};
