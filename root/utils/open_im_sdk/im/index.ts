...
export default class OpenIMSDK extends Emitter {
  ...
  markGroupMessageAsRead = (data: MarkGroupParams, operationID?: string) => {
    return new Promise<WsResponse>((resolve, reject) => {
      let tmp: any = data;
      tmp.msgIDList = JSON.stringify(tmp.msgIDList);
      const _uuid = operationID || uuid(this.uid as string);
  ...
  getFollowFriendApplicationList = (data: GetFollowListParams, operationID?: string) => {
    return new Promise<WsResponse>((resolve, reject) => {
      const _uuid = operationID || uuid(this.uid as string);
      const args = {
        reqFuncName: RequestFunc.GETFOLLOWFRIENDAPPLICATIONLIST,
        operationID: _uuid,
        userID: this.uid,
        data,
      };
  ...
  followAddFriend = (data: FollowAddFriendParams, operationID?: string) => {
    return new Promise<WsResponse>((resolve, reject) => {
      const _uuid = operationID || uuid(this.uid as string);
      const args = {
        reqFuncName: RequestFunc.FOLLOWADDFRIEND,
        operationID: _uuid,
        userID: this.uid,
        data,
      };
  ...
  updateProduce = (data: updateProduceParams, operationID?: string) => {
    return new Promise<WsResponse>((resolve, reject) => {
      const _uuid = operationID || uuid(this.uid as string);
      const args = {
        reqFuncName: RequestFunc.UPDATEPRODUCE,
        operationID: _uuid,
        userID: this.uid,
        data,
      };
