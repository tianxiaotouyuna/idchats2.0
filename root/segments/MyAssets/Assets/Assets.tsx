...
const Assets: FunctionComponent<ExGoodsCardProps> = (props) => {
        ...
        >
            <View style={[styles.container, style, { flexDirection: 'row', alignItems: 'center',justifyContent:'space-between' }]}>
                <View style={{flexDirection:'row', alignItems: 'center'}}>
                    <FastImage style={{ backgroundColor: 'red', width: pxToDp(100), height: pxToDp(100), margin: pxToDp(20), borderRadius: pxToDp(10) }} resizeMode='cover' source={{ uri: data?.header }} />
